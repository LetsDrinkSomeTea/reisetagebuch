...
![Dinner]({{ site.baseurl }}/journeys/{{ page.journey }}/tag-{{ page.day }}/dinner-3.jpg)
...
![Dinner]({{ site.baseurl }}/journeys/{{ page.journey }}/tag-{{ page.day }}/dinner-4.jpg)

Das `Dessert` war eine Tarte mit Creme und Melone, die hervorragend schmeckte.

![Dinner]({{ site.baseurl }}/journeys/{{ page.journey }}/tag-{{ page.day }}/dinner-5.jpg)
